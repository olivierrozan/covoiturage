...
initialize = function(){
  ...
  map      = new google.maps.Map(document.getElementById('d_map'), myOptions);
...
//calculate = function(){
    ...
    origin      = document.getElementById('origin').innerText; // Le point départ
    destination = document.getElementById('destination').innerText; // Le point d'arrivée
